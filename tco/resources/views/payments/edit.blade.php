                ...
                <div class="card-body">
                    <form method="post" action="/payments/edit/{{ $payment->id }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required autofocus  value="{{ $payment->description }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input id="payment" type="text" class="form-control{{ $errors->has('payment') ? ' is-invalid' : '' }} money" name="payment" value="{{ $payment->payment }}" required>
